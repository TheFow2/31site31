<?php 
    if (!defined('R_PILOT')) { exit(); }
        ...
        if ( !empty($_POST['ss_sitename']) && !empty($_POST['ss_siteurl']) && !empty($_POST['ss_sitetheme']) && !empty($_POST['ss_sitelang']) ) {
            if ( isset($_POST['ss_sitename']) && isset($_POST['ss_siteurl']) && isset($_POST['ss_sitetheme']) && isset($_POST['ss_sitelang']) ) {
                $adm_ss = array();
